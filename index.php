				...
				<div id="main">
					...
					<section class="tiles">
						<article>
							...
							<header class="major">
								<p>
				                   <i class="fa fa-calendar"></i> 26-04-2021 &nbsp;&nbsp;
				                </p>
						...
						<article>
							<span class="image">
								<img src="images/projet5.png" alt="" />
							</span>

							<header class="major">
								<p>
				                   <i class="fa fa-calendar"></i> 19-11-2020 &nbsp;&nbsp;
				                </p>
					...
					<section>
						<div class="inner">
							...
							<div class="row">
								...
								<div class="col-6">
									<p>Formations d'Enseignement</p>
									<p><strong>- Dev Log, Dev Web, Administration Base de données, Analyse DATA</strong></p>
								</div>
							</div>
						</div>
					</section>
